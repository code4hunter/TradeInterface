...
#define KCBP_OPTION_USERNAME		11
#define KCBP_OPTION_PASSWORD		12
...
KCBPCLI_API int KCBPCLISTDCALL KCBPCLI_GetValue(KCBPCLIHANDLE hHandle, const char *KeyName, char *Vlu, int Len);
KCBPCLI_API int KCBPCLISTDCALL KCBPCLI_SetValue(KCBPCLIHANDLE hHandle, const char *KeyName, const char *Vlu);
...
/*KCBPCLI_API int KCBPCLISTDCALL KCBPCLI_RsGetCol(KCBPCLIHANDLE hHandle, char *KeyName, char *Vlu) ;*/
KCBPCLI_API int KCBPCLISTDCALL KCBPCLI_RsGetColByName(KCBPCLIHANDLE hHandle, const char *KeyName, char *Vlu);
